...
<html>
  <head>
    ...
    <title>My JSP 'admin-lend-success.jsp' starting page</title>
  ...
  <body>
   借阅号与学号与书号匹配成功，还书成功！<hr>

  <%
  			int a= Integer.parseInt(session.getAttribute("bookid2").toString());
            ...
            {%>
						<tr class="border-b">
							...
							归还的书籍ID:<td class="py-2"><%=b.getBookId() %></td><hr>
							归还的书籍名字:<td class="py-2"><%=b.getBookName() %></td><hr>
						...
						<%}
			%>
 			<a href="admin-main-check.jsp">继续核对还书信息</a><hr>
