...
<html>
  ...
  <body class="bg-grey-lighter font-sans antialiased">
 	<div id="container">
			...
			<hr>
			<div id="main">
			 	<form method="post" action="Admin-lend.action">
				<table width="100%" height="40px" align="center" cellpadding="0px" cellspacing="0px">
					<tr>
					<td>学号：<input name="lb.stu.stuId" id="lbstustuId" type="text" size="18" placeholder="8位数字"></td>
					</tr>
					<tr>
					<td>书号：<input name="lb.book.bookId" id="lbstustuId" type="text" size="18" placeholder="4位数字"></td>
					</tr>
					</br>
					<tr>
					<td>借阅号：<input name="lb.lendId" id="lblendId" type="text" size="18" placeholder="10位数字"></td>
					</tr>
					<tr>
					<td align="center">
						
						<input type=submit value="审核" > &nbsp;&nbsp;&nbsp;<input type="reset" value="重置">
					</td>
					</tr>
				</table>
				</form>
			...
			<font color="red" size="40">警告⚠ </font><br>
			<font color="red" size="12"> 还书审核</font>
			<%
			String lendid="";
			request.setAttribute(lendid,"lb.lendId");
