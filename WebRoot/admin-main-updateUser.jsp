...
<html>
  ...
  <body class="bg-grey-lighter font-sans antialiased">
 	<div id="container">
			...
			<hr>
			<div id="main">
			 	<form method="post" action="Admin-updatestu.action">
				<table width="100%" height="40px" align="center" cellpadding="0px" cellspacing="0px">
					<tr>
					<td>学号：<input name="st.stuId" id="stuid" type="text" size="18" placeholder="8位数字"></td>
					</tr>
					</br>
					<tr>
					<td>姓名：<input name="st.stuName" id="stuid" type="text" size="18" placeholder="不能为空"></td>
					</tr>
					<tr>
					<td>诚信：<input name="st.stuIntegrity" id="stuid" type="text" size="18" placeholder="不能为空"></td>
					</tr>
					<tr>
					<td>★★★★★(复制图标，添加到诚信框内，5星代表最高等级！)</td>
					</tr>
					<tr>
					<td align="center">
