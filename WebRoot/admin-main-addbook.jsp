...
<html>
  ...
  <body class="bg-grey-lighter font-sans antialiased">
 	<div id="container">
			...
			<hr>
			<div id="main">
			 	<form method="post" action="Admin-addbook.action">
				<table width="100%" height="40px" align="center" cellpadding="0px" cellspacing="0px">
					...
					<tr>
					<td>书名：<input name="bk.bookName" id="stuid" type="text" size="18" placeholder="不能为空"></td>
					</tr>
					<tr>
					<td>作者：<input name="bk.bookAuthor" id="stuid" type="text" size="18" placeholder="不能为空"></td>
					</tr>
					<tr>
					<td>出版社：<input name="bk.bookPub" id="stuid" type="text" size="18" placeholder="不能为空"></td>
					</tr>
					<tr>
					<td>数量：<input name="bk.bookNum" id="stuid" type="text" size="18" value="6" readonly="readonly"></td>
					</tr>
					<tr>
					<td>分类：<input name="bk.sortId" id="stuid" type="text" size="18" placeholder="不能为空"></td>
					</tr>
					<tr>
					<td>登记日期：<input name="bk.bookRecord" id="stuid" type="text" size="18" value="<%=date%>" readonly="readonly"></td>
					</tr>
					<tr>
					<td>书架号：<input name="bk.bookcaseId" id="stuid" type="text" size="18" placeholder="2位数字"></td>
					</tr>
					<tr>
					<td>书层号：<input name="bk.bookcaseLayer" id="stuid" type="text" size="18"placeholder="1位数字" ></td>
					</tr>
					<tr>
					<td align="center">
